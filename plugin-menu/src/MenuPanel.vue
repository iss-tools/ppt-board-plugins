...
const menuOptions = computed(() => [
  ...
  },
  {
    label: t('menu.about'),
    key: 'about',
    icon: renderRawIcon(`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>`)
  },
  {
    label: t('menu.privacy'),
    key: 'privacy',
    icon: renderRawIcon(`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>`)
  },
  {
    label: t('menu.terms'),
    key: 'terms',
    icon: renderRawIcon(`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>`)
  },
  {
    type: 'divider',
    key: 'd2'
...
const handleSelect = (key: string | number) => {
  if (key === 'open') {
    ...
    dialog.info({
      ...
      style: 'width: 600px;',
      content: () => h('div', { style: 'font-size: 14px; line-height: 1.6; white-space: pre-wrap; max-height: 60vh; overflow-y: auto; padding-right: 8px;' }, t('about.privacyContent')),
    ...
    dialog.info({
      title: t('menu.terms'),
      style: 'width: 600px;',
      content: () => h('div', { style: 'font-size: 14px; line-height: 1.6; white-space: pre-wrap; max-height: 60vh; overflow-y: auto; padding-right: 8px;' }, t('about.termsContent')),
      positiveText: t('menu.confirm')
    });
  }
};
